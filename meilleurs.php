...
<head>
	...
	<title>Les meilleurs - Kwar</title>
...
<body>
	...
	<div class="row">
		<div class="large-8 medium-8 columns">
			<h5>Vos chats préférés :</h5>
			<div class="row">
				<?php
            // Récupération des 10 meilleurs chats
				$reponse = $db->query('SELECT * FROM tblchat WHERE chatVotesPositifs != 0 AND chatVotesPositifs != 0 ORDER BY chatVotesPositifs/(chatVotesPositifs+chatVotesNegatifs) DESC LIMIT 0, 10');
		...
		<div class="large-4 medium-4 columns">
			<p>
				...
				<a class="medium expand success disabled button">Les meilleurs</a><br/>
